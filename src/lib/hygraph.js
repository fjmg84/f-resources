...
import { ALL_CATEGORIES, ALL_POSTS_QUERY, POSTS_BY_CATEGORY_QUERY } from './queries';

const hygraph = new GraphQLClient(import.meta.env.VITE_GRAPHQL_URL, {
	headers: {}
});

export const getAllPostQuery = async () => await hygraph.request(ALL_POSTS_QUERY);
...
export const getAllCategoriesQuery = async () => await hygraph.request(ALL_CATEGORIES);
